...
export class BaseSchema1769811455321 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_a48b6399c9111fe3c54ee9b3ab" ON "ride_requests" USING GiST ("pickup_point") `);
        await queryRunner.query(`CREATE TYPE "public"."trip_riders_status_enum" AS ENUM('JOINED', 'CANCELLED', 'NO_SHOW')`);
        await queryRunner.query(`CREATE TABLE "trip_riders" ("trip_id" uuid NOT NULL, "rider_user_id" uuid NOT NULL, "pickup_point" geography(Point,4326) NOT NULL, "drop_point" geography(Point,4326) NOT NULL, "pickup_sequence" integer, "drop_sequence" integer, "fare_share" numeric(10,2), "status" "public"."trip_riders_status_enum" NOT NULL DEFAULT 'JOINED', CONSTRAINT "PK_3b6117cc140d0828d145d2d8a4e" PRIMARY KEY ("trip_id", "rider_user_id"))`);
        await queryRunner.query(`CREATE TABLE "trip_events" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "trip_id" uuid NOT NULL, "event_type" text NOT NULL, "old_value" text, "new_value" text, "metadata" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_df6ea3b2ad6f86f525d796220da" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."trips_status_enum" AS ENUM('REQUESTED', 'ASSIGNED', 'ARRIVING', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED')`);
        ...
        await queryRunner.query(`CREATE TABLE "audit_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "actor_user_id" uuid, "target_user_id" uuid, "action_type" text NOT NULL, "reason" text, "metadata" jsonb, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_1bb179d048bbc581caa3b013439" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "ride_requests" ADD CONSTRAINT "FK_575b85b47b55e9db7f417d9615d" FOREIGN KEY ("rider_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "trip_riders" ADD CONSTRAINT "FK_ca3059c3315c1dbdbf20ad6afdf" FOREIGN KEY ("trip_id") REFERENCES "trips"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "trip_riders" ADD CONSTRAINT "FK_948ebe379770af13cc1ee28f5a4" FOREIGN KEY ("rider_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "trip_events" ADD CONSTRAINT "FK_7f990838ba955f659ec0abfcb31" FOREIGN KEY ("trip_id") REFERENCES "trips"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "trips" ADD CONSTRAINT "FK_9e5c1f3a92e0b51914f0b55e242" FOREIGN KEY ("driver_user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_c49454aef596e6f9dc3eb64f3c6" FOREIGN KEY ("target_user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "vehicles" ADD CONSTRAINT "FK_08d0cec0d40811ede63402e191a" FOREIGN KEY ("driver_user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "vehicles" DROP CONSTRAINT "FK_08d0cec0d40811ede63402e191a"`);
        await queryRunner.query(`ALTER TABLE "audit_logs" DROP CONSTRAINT "FK_c49454aef596e6f9dc3eb64f3c6"`);
        await queryRunner.query(`ALTER TABLE "audit_logs" DROP CONSTRAINT "FK_f160d97a931844109de9d04228f"`);
        await queryRunner.query(`ALTER TABLE "trips" DROP CONSTRAINT "FK_9e5c1f3a92e0b51914f0b55e242"`);
        await queryRunner.query(`ALTER TABLE "trip_events" DROP CONSTRAINT "FK_7f990838ba955f659ec0abfcb31"`);
        await queryRunner.query(`ALTER TABLE "trip_riders" DROP CONSTRAINT "FK_948ebe379770af13cc1ee28f5a4"`);
        await queryRunner.query(`ALTER TABLE "trip_riders" DROP CONSTRAINT "FK_ca3059c3315c1dbdbf20ad6afdf"`);
        await queryRunner.query(`ALTER TABLE "ride_requests" DROP CONSTRAINT "FK_575b85b47b55e9db7f417d9615d"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_a48b6399c9111fe3c54ee9b3ab"`);
